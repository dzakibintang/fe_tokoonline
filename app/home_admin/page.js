  ...
  return (
    <>
      ...
      <main className="p-6 bg-gray-100 min-h-screen">
        ...
        <p className="text-gray-600 mb-6">Selamat datang, Admin! Kelola produk Anda di bawah ini.</p>
          ...
          {produk.length > 0 ? (
            produk.map((item) => (
              ...
              >
                ...
                />
                <h2 className="text-xl font-semibold text-gray-700 mb-2">{item.nama}</h2>
                <p className="text-gray-500 mb-2">Rp {Number(item.harga).toLocaleString('id-ID')}</p>
                <p className="text-gray-500 mb-4">Stok: {item.stok}</p>
          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 w-full max-w-md">
              ...
              <form onSubmit={handleUpdate}>
                ...
                <div className="mb-4">
                  <label className="block text-gray-700 mb-2">Gambar (opsional)</label>
                  <input
                    type="file"
                    name="gambar"
                    accept="image/*"
